/*
To compile this C program into an ARM executable binary,
...
*
* This program uses libcurl to send HTTP requests.
*
...
// Supported HTTP methods
// These map directly to command-line flags
typedef enum {
METHOD_NONE,
METHOD_GET,
METHOD_POST,
...
// Structure used to store server response
struct memory {
char *response;
size_t size;
};

// Callback function for libcurl response data
...
// Supported long command line options
...
// Combine remaining arguments into one string
